...
const fullTokenMap: FullTokenMap = {
    default: {
        ...
        markup: buildTokenSettings(palette.black),
        ...
        entity: buildTokenSettings(palette.black),
        ...
        constant: buildTokenSettings(palette.black),
        "constant.numeric": buildTokenSettings(palette.darkYellow),
        "constant.language": buildTokenSettings(palette.gray),
        ...
        keyword: buildTokenSettings(palette.black),
        ...
        "keyword.operator": buildTokenSettings(palette.gray),
        "keyword.other": buildTokenSettings(palette.red),

        storage: buildTokenSettings(palette.black),
        ...
        variable: buildTokenSettings(palette.black),
        ...
        string: buildTokenSettings(palette.black),
        ...
        support: buildTokenSettings(palette.black),
        ...
        "support.other": buildTokenSettings(palette.gray),

        punctuation: buildTokenSettings(palette.gray),
        "punctuation.definition": buildTokenSettings(palette.gray),
        ...
        "meta.brace.round": buildTokenSettings(palette.gray),
        "meta.brace.square": buildTokenSettings(palette.gray),
