...
export const defaultTokenMap: TokenMap<DefaultTokenScope> = {
    ...
    markup: { foreground: palette.white },
    ...
    entity: { foreground: palette.white },
    ...
    constant: { foreground: palette.white },
    "constant.numeric": { foreground: palette.darkYellow },
    "constant.language": { foreground: palette.blue },
    ...
    keyword: { foreground: palette.magenta, fontStyle: "bold" },
    "keyword.control": { foreground: palette.red },
    ...
    storage: { foreground: palette.white },
    ...
    variable: { foreground: palette.white },
    ...
    support: { foreground: palette.white },
